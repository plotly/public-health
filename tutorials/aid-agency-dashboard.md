...
- [Create a Chart](#2-create-a-chart)
  - [Aid Agency Location Satellite Map](#21-agency-location-satellite-map)
  - [Activities Pie Chart](#22-activities-pie-chart)
  - [Countries Pie Chart](#23-countries-pie-chart)
  - [Total Activity Bar Chart](#24-total-activity-bar-chart)
...
Alternatively, navigate to the [Chart Studio](https://plot.ly/create/) and click **Import**, **By URL**, and then paste in the **URL** (https://plot.ly/~jackp/18129.csv).
...
![Crossfilter](../screencasts/ebola_humanitarian_aid.gif)
